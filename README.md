...
2. [How AEGIS Works](#how-aegis-works)
3. [Project Structure](#project-structure)
4. [Building on Linux](#building-on-linux)
5. [Using AEGIS](#using-aegis)
6. [API Reference](#api-reference)
   - [`arena_alloc()`](#arena_alloc)
   - [`arena_alloc_zeroed()`](#arena_alloc_zeroed)
   - [`arena_resize()`](#arena_resize)
   - [`free_all()`](#free_all)
   - [`capacity()`](#capacity)
   - [`offset()`](#offset)
7. [Ownership and Move Semantics](#ownership-and-move-semantics)
8. [Allocation and Alignment](#allocation-and-alignment)
9. [Zeroed vs Non-Zeroed Allocation](#zeroed-vs-non-zeroed-allocation)
10. [Resizing Allocations](#resizing-allocations)
11. [Example Usage](#example-usage)
12. [Benchmarking](#benchmarking)
13. [Benchmark Methodology](#benchmark-methodology)
14. [AEGIS vs malloc](#aegis-vs-malloc)
15. [AEGIS vs calloc](#aegis-vs-calloc)
16. [AEGIS vs `std::pmr::monotonic_buffer_resource`](#aegis-vs-stdpmrmonotonic_buffer_resource)
17. [Correctness Testing](#correctness-testing)
18. [Hardening Testing](#hardening-testing)
19. [Sanitizer Testing](#sanitizer-testing)
